...
makedepends=('gcc-fortran' 'suitesparse' 'texinfo' 'gnuplot' 'fltk' 'portaudio' 'jdk-openjdk' 'rapidjson')
...
source=(https://ftp.gnu.org/gnu/octave/octave-$pkgver.tar.gz{,.sig}
        https://github.com/gnu-octave/octave/commit/7ea31a1e.patch)
options=('!emptydirs')
...
sha512sums=('987dac6bd6d41316e1bb12f544a4ed8767639e60a117ad7125f2b299bf3dbdb516b6a657fcce5b597759bcaa1f8e49d91bead7a4c43fac73c16cb4818de9c29d'
            'SKIP'
            '761ccbdc5a9b3eeb95a6f57c5264624203ce787436962cabdadcc0f7b4a57f034e42a431ec10e8cef472119a4842f846e54c073714d32d16f4e4fe42fbd7d6e6')

prepare() {
  patch -d $pkgname-$pkgver -p1 < 7ea31a1e.patch # Fix build with suitesparse 7.1
}
